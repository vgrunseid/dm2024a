...
dataset_dep <- dataset %>% 
  as_tibble() %>% 
  select(-mprestamos_personales,-mcomisiones,-mcomisiones_otras,-ccomisiones_otras,-mpasivos_margen,-ctransferencias_recibidas,-ccheques_emitidos,-cmobile_app_trx,-ccajas_extracciones,-ccheques_depositados,-cpagodeservicios,-cpagomiscuentas,-ccajeros_propios_descuentos,-cforex,-cforex_buy,-cforex_sell,-mforex_sell,-ccheques_depositados_rechazados,-Master_cadelantosefectivo,-Visa_cadelantosefectivo) %>% 
  as.data.table()
