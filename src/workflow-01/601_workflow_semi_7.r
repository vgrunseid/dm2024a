...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$lag1 <- TRUE #vcg
  param_local$lag2 <- TRUE # no me engraso con los lags de orden 2 #cvg
  param_local$lag3 <- TRUE # no me engraso con los lags de orden 3 #cvg
...
#  param_local$final_train <- c(202007, 202006, 202105, 202104,
    param_local$final_train <- c(202007, 202105, 202104, #vcg
...
#    boosting = "gbdt", # puede ir  dart  , ni pruebe random_forest
     boosting = "dart", # puede ir  dart  , ni pruebe random_forest #vcg
    ...
    num_iterations = 60, # un numero muy grande, lo limita early_stopping_rounds
    ...
    num_leaves = c( 40L,  50L,  "integer" ), #vcg
    min_data_in_leaf = c( 100L, 200L, "integer" ) #vcg
  )
...
ZZ_final_semi_base <- function( pinputexps)
{
  ...
  param_local$semillerio <- 30 #vcg
  param_local$semillerio <- 60
