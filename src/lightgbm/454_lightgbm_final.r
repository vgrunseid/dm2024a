...
PARAM$finalmodel$learning_rate <- 0.0225119525973517
PARAM$finalmodel$feature_fraction <- 0.446811762921476
PARAM$finalmodel$min_data_in_leaf <- 257
PARAM$finalmodel$num_leaves <- 624
