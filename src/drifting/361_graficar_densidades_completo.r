...
#dataset <- fread("~/buckets/b1/expw/DR-0005/dataset.csv.gz")
...
campos_buenos <- colnames(dataset)
...
pdf( paste0("densidades_entrenamiento_testing completo mes09 - DT01.pdf") )

for (campo in campos_buenos) {
  cat(campo, "  ")
  
  #  if (is.numeric(dataset[[campo]])){
